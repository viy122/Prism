...
<head>
    ...
    <title>Budget Utilization Report | PRISM — Finance Office</title>
...
<aside class="sb">
    ...
    <nav class="sb-nav">
        ...
        <a href="{{ route('finance-office.budget-utilization-report') }}" class="active">
...
<div class="main">
    ...
    <header class="topbar">
        <span class="topbar-title">Budget Utilization Report</span>
    </header>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <h1 class="card-title">Budget Utilization Report</h1>
            <p class="card-sub">Track campus budget utilization, offices at risk, and office-level spending progress by quarter.</p>
        </div>
        ...
        {{-- Office Spending Progress table --}}
        <div class="card">
            <div class="card-head">
                <div>
                    ...
                    <tbody>
                        @foreach ($utilizationRows as $row)
                            ...
                            <tr data-util-row
                                ...
                                <td style="font-size:13px;font-weight:600;color:var(--s600);">
                                    {{ $row['office'] }}
                                </td>
                                ...
                                <td>
                                    <p class="amount-val">PHP {{ number_format($row['budget']) }}</p>
                                </td>
                                <td>
                                    <p class="amount-val">PHP {{ number_format($row['utilized']) }}</p>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="risk-badge {{ $riskSlug }}">{{ $row['risk'] }}</span>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
