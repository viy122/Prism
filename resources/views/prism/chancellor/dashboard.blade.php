...
<head>
    ...
    <title>Campus Monitoring Dashboard | PRISM</title>
...
<aside class="sb">
    ...
    <nav class="sb-nav">
        <a href="{{ route('chancellor.dashboard') }}" class="active">
...
<div class="main">
    ...
    <header class="topbar">
        <span class="topbar-title">Campus Monitoring Dashboard</span>
    </header>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <h1 class="card-title">Campus Monitoring Dashboard</h1>
            <p class="card-sub">Monitor APP accomplishment, utilization, office risk, quarterly procurement movement, and overdue PR alerts across campus.</p>
        </div>
        ...
        {{-- Year-End Utilization + Office Ranking --}}
        <div class="two-col">
                                    ...
                                    <td>
                                        <div class="prog-wrap">
                                            ...
                                            <div class="prog-track">
                                                <div class="prog-fill-maroon" style="width:{{ $forecast['currentUtilization'] }}%"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="prog-wrap">
                                            ...
                                            <div class="prog-track">
                                                <div class="prog-fill-gold" style="width:{{ $forecast['forecast'] }}%"></div>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <table>
                        ...
                        <tbody>
                            @foreach ($utilizationRankings as $rank)
                                ...
                                <tr>
                                    <td>
                                        <span class="rank-num {{ $rank['rank'] <= 3 ? 'top' : '' }}">
                                            {{ $rank['rank'] }}
                                        </span>
                                    </td>
        ...
        <div class="card">
            <div class="card-head">
                ...
                <span class="count-chip badge-critical" style="height:28px;padding:0 12px;border-radius:20px;font-size:11px;font-weight:700;background:#fcebeb;color:#a32d2d;border:1px solid #f7c1c1;">
