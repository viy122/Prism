    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (min-width: 1024px) {
            .login-wrap { grid-template-columns: 1fr 520px; }
        }
        ...
        .stripe-1 { top: 10%; right: 25%; animation-delay: 0s; }
        .stripe-2 { top: 30%; right: 40%; animation-delay: 1.5s; height: 130px; }
        .stripe-3 { top: 60%; right: 15%; animation-delay: 0.8s; height: 90px; }
        ...
        .left-logo-img:hover { transform: scale(1.06); }
        .left-logo-img img { width: 100%; height: 100%; object-fit: contain; }
        .left-logo-text { font-size: 22px; font-weight: 900; color: #fff; letter-spacing: .5px; }
        .left-logo-sub { font-size: 11px; font-weight: 600; color: rgba(255,255,255,.5); letter-spacing: .08em; margin-top: 1px; }
        ...
        .hero-title em { font-style: normal; color: #c9a84c; }
        .hero-desc {
        ...
        .shield-wrap {
            ...
            border-radius: 18px;
            background: #fff;
            border: 1.5px solid rgba(104,16,18,.12);
            box-shadow: 0 4px 18px rgba(104,16,18,.1);
            margin-bottom: 18px;
            transition: transform .3s, box-shadow .3s;
        }
        .shield-wrap:hover { transform: translateY(-3px); box-shadow: 0 8px 28px rgba(104,16,18,.15); }
        .shield-wrap svg {
            width: 26px; height: 26px;
            stroke: #681012; fill: none;
            stroke-width: 2; stroke-linecap: round; stroke-linejoin: round;
        }
        .form-title { font-size: 22px; font-weight: 800; color: #0f172a; letter-spacing: -.4px; }
        .form-sub { font-size: 13px; color: #64748b; margin-top: 6px; line-height: 1.5; }

        /* Card */
        .form-card {
            background: #fff;
            border: 1px solid rgba(104,16,18,.1);
            border-radius: 20px;
            padding: 32px 28px 28px;
            box-shadow: 0 8px 40px rgba(104,16,18,.08), 0 2px 8px rgba(104,16,18,.04);
        }
        ...
        .field-input:focus {
            border-color: #681012;
            background: #fff;
            box-shadow: 0 0 0 3.5px rgba(104,16,18,.1);
        }
        .field-input:focus ~ .input-icon svg,
        .input-wrap:focus-within .input-icon svg { stroke: #681012; }
        ...
        .pw-toggle:hover { background: #f1f5f9; color: #681012; }
        ...
        .forgot-link {
            ...
            color: #681012; text-decoration: none;
        ...
        .btn-login {
            ...
            box-shadow: 0 4px 16px rgba(104,16,18,.3);
        }
        .btn-login::before {
            content: '';
            position: absolute;
        ...
        .btn-login:hover { opacity: .9; box-shadow: 0 6px 22px rgba(104,16,18,.38); }
        ...
        .input-wrap { position: relative; }
        .input-wrap .input-icon { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); pointer-events: none; z-index: 1; }

        /* Error state */
        .field-input.error { border-color: #e24b4b; box-shadow: 0 0 0 3px rgba(226,75,75,.1); }
        .field-error { font-size: 11px; color: #a32d2d; font-weight: 600; margin-top: 5px; display: none; }
        .field-error.show { display: block; }

        /* Focus visible ring for accessibility */
        .btn-login:focus-visible, .demo-btn:focus-visible {
        ...
        @media (max-width: 1023px) {
            ...
            .right-panel { background: linear-gradient(160deg, #f8f4f4 0%, #f0e9e9 100%); min-height: 100vh; }
        }
    </style>
</head>
<body>
    ...
    <section class="right-panel">
        <div class="form-box">
                ...
                <form id="loginForm" method="POST" action="#">
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input class="field-input" type="text" id="emailInput" name="email" autocomplete="username" placeholder="Enter your username or email">
                        </div>
            ...
            <div class="demo-box">
                ...
                <div class="demo-grid">
                    <a class="demo-btn" href="{{ route('office-head.dashboard') }}">
                        <svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>
                        Office Head / Dean
                    </a>
                    <a class="demo-btn" href="{{ route('finance-office.dashboard') }}">
                        <svg viewBox="0 0 24 24"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>
                        Finance Office
                    </a>
                    <a class="demo-btn" href="{{ route('procurement-office.dashboard') }}">
                    ...
                    <a class="demo-btn" href="{{ route('chancellor.dashboard') }}">
                        <svg viewBox="0 0 24 24"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></svg>
                        Chancellor
                    </a>
                    <a class="demo-btn full" href="{{ route('vice-chancellor.dashboard') }}">
