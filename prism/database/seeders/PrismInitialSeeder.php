...
class PrismInitialSeeder extends Seeder
{
    public function run(): void
    {
        ...
        collect([
            ...
            [
                'name' => 'Mrs. Eleonor T. Laña',
                'username' => 'finance',
                'email' => 'finance.office@prism.test',
                'position_title' => 'Head, Budget Office',
                'office' => 'FIN',
                'role' => 'finance-office',
            ],
            [
                'name' => 'Mrs. Marife G. Galvezo',
                'username' => 'procurement',
                'email' => 'procurement.office@prism.test',
                'position_title' => 'Head, Procurement Office',
                'office' => 'PROC',
            ...
            [
                'name' => 'Mrs. Apple Kheer R. Chuidian',
                'username' => 'accounting',
                'email' => 'accounting.office@prism.test',
                'position_title' => 'Head, Accounting Office',
                'office' => 'ACCT',
            ...
            [
                'name' => 'Mrs. Anna Lisa B. Villapando',
                'username' => 'cashier',
                'email' => 'cashier@prism.test',
                'position_title' => 'Head, Cashiering Office',
                'office' => 'CASH',
                'role' => 'cashier',
            ],
            [
