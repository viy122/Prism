...
<div class="content">
    ...
    <div class="stat-grid">
        <div class="stat-card">
            <div class="stat-icon"><svg viewBox="0 0 24 24"><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg></div>
            <p class="stat-label">Delivered — For Processing</p>
            <p class="stat-value">{{ $summary['forProcessing'] }}</p>
            <p class="stat-hint">Ready to start payment processing</p>
        </div>
        <div class="stat-card">
            ...
            <p class="stat-value">{{ $summary['awaitingCashier'] }}</p>
