...
(function () {
    ...
    const URL_COUNT    = '<?php echo e(route("notifications.count")); ?>';
    const URL_LIST     = '<?php echo e(route("notifications.index")); ?>';
    const URL_READ_ALL = '<?php echo e(route("notifications.read-all")); ?>';
    const URL_READ_ONE = '<?php echo e(url("notifications")); ?>'; // + '/{id}/read'
...
<?php /**PATH C:\xampp\htdocs\Prism\resources\views/prism/partials/notification-bell.blade.php ENDPATH**/ ?>