...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'PRISM'); ?> | PRISM</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@2.44.0/tabler-icons.min.css">
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js']); ?>
    <?php echo $__env->yieldPushContent('head-extras'); ?>
    <style>
...
<aside class="sb">
    ...
    <a class="sb-brand" href="<?php echo e($brandHref ?? route('office-head.dashboard')); ?>">
        <div class="sb-logo">
            <img src="<?php echo e(asset('images/prism.png')); ?>" alt="PRISM logo"
    ...
    ?>
    <nav class="sb-nav">
        <?php $__currentLoopData = $officeHeadNav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e($item['href']); ?>" title="<?php echo e($item['label']); ?>"
           <?php if(($activeModulePage ?? '') === $item['slug']): ?> class="active" aria-current="page" <?php endif; ?>>
            <i class="ti ti-<?php echo e($item['icon']); ?>"></i>
            <span class="sb-label"><?php echo e($item['label']); ?></span>
            <?php if(($activeModulePage ?? '') === $item['slug']): ?>
    ...
    <div class="sb-bottom">
        <div class="sb-user">
            ...
            <div class="sb-user-info">
                ...
                <div class="sb-user-name"><?php echo e($roleLabel ?? 'Office Head / Dean'); ?></div>
            </div>
        </div>
...
<div class="main">
    ...
    <div class="univ-header">
        <img class="hdr-bg" src="<?php echo e(asset('images/headers2.png')); ?>" alt="Batangas State University"
        ...
        <div class="univ-header-right">
            <?php echo $__env->make('prism.partials.notification-bell', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <div>
...
<?php /**PATH C:\xampp\htdocs\Prism\resources\views/prism/layouts/office-head.blade.php ENDPATH**/ ?>